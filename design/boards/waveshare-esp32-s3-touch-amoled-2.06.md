...
- 整机 42.00 × 50.80 × 12.90(顶)/13.60(底) mm；表带卡口宽 22.00mm
- **正面玻璃窗口 33.09 × 40.51 mm = 显示 AA 一比一**（410×502 @ 12.39px/mm）
- **窗口圆角 R9.2mm ≈ 114px**——UI 安全区依据（`BBCLAW_DISPLAY_CORNER_RADIUS 114`）。
  注意：外形 PDF 里的 R4.5 是背板开孔标注，别再误用。
