 ...
 * 已由设置菜单「拍照」项做按需 init→拍→deinit，boot 自测无需常开；需 bring-up 回归时临时置 1。 */
#define BBCLAW_CAMERA_SELFTEST   0
/* Phase 1 端到端测试钩子：cloud 连上后自动拍一张发上去。已由设置菜单「拍照」项取代，
 * 平时关闭；需要免手动回归时临时置 1。 */
#define BBCLAW_CAMERA_TEST_UPLOAD 0
